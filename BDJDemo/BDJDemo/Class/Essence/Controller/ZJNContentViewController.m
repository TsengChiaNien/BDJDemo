//
//  ZJNAllContentController.m
//  百思不得姐
//
//  Created by 曾嘉年 on 16/6/1.
...
@interface ZJNContentViewController ()
/** 网络请求管理 */
...
@implementation ZJNContentViewController
...
- (void)setUpContentRefresh {
    ...
    self.tableView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        if (weakSelf.maxtime) [weakSelf sendURLRequestWithMaxtime:weakSelf.maxtime];
    }];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setCommentBlock:^{
        [weakSelf pushCommentViewControllerAtIndexPath:indexPath];
    }];
    return cell;
}
