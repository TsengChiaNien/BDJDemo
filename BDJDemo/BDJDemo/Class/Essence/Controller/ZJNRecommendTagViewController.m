...
@interface ZJNRecommendTagViewController ()
/** 网络请求管理 */
...
@implementation ZJNRecommendTagViewController
...
- (void)sendURLRequest {
    ...
    [self.manager GET:@"http://api.budejie.com/api/api_open.php" parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        self.recommendTags = [ZJNRecommendTag mj_objectArrayWithKeyValuesArray:responseObject];
